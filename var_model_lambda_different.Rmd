...
**Data Preprocessing (deseasonalized, removed variance):**

-   Lambda calculated for arrival,globcci time series in training data.

-   Applied boxcox transformation to both train and test time series based on above lambda value
...
```{r}
arrival_bc <- BoxCox(train[,"deseasonalized_arrival"], lambda = l_arrival)
# oil_bc <- BoxCox(train[,"deseasonalized_oil"], lambda = l_oil)
# geopol_bc <- BoxCox(train[,"deseasonalized_geopol"], lambda = l_geopol)
globcci_bc <- BoxCox(train[,"deseasonalized_globcci"], lambda = l_globcci)
```
...
arrival_bc_test <- BoxCox(test[,"deseasonalized_arrival"], lambda = l_arrival)
# oil_bc_test <- BoxCox(test[,"deseasonalized_oil"], lambda = l_oil)
# geopol_bc_test <- BoxCox(test[,"deseasonalized_geopol"], lambda = l_geopol)
globcci_bc_test <- BoxCox(test[,"deseasonalized_globcci"], lambda = l_globcci)
```
...
we can see some autocorrelation so it doesn't resemble white noise yet.?
